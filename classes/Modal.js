...
export default class Modal {
   ...
   */
  constructor({ element, options = {}, componentName, data = {}, permissions = null }) {
  ...
  async loadComponent(name) {
    try {
      const component = await import(/* webpackMode: "eager" */ `@views/Modals/${name}.vue`);

      if (component.default) {
        return component.default;
      }
    } catch (err) {
      const component = await import(/* webpackMode: "eager" */ `@sdk/views/Modals/${name}.vue`);
